...
<html>
    ...
    <body class="bg-primary">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
              <ul class="navbar-nav me-auto">
                <li class="nav-item">
                  <a class="nav-link active" href="admin.jsp">Grupos
                ...
                <li class="nav-item">
                  <a class="nav-link" href="eventos.jsp">Categorias</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <center>
            ...
            <div class="join-main">
                <s3>A continuación verás los participantes registrados</s3>
                <s4>
                    <table class="table table-hover" border="3" >
                        <thead>
                            <tr class="table-info">
                                ...
                                <th> 
                                    <a href="altasfaq.html"><center><button class="btn btn-dark" ><i class="fas fa-user-plus"></i></button></center></a>
                                </th>
                            </tr>
                        </thead>
                        <thead>
                            ...
                            <%
                                try {
                                    bd.conectar();
                                    String strQry1 = "select * from Persona";
                                    ResultSet rs = null;
                                    int ID;
                            ...
                            %>
                                        <tbody>
                                            <tr class="table-info">
                                                ...
                                                <th><a href="agregarGrupo.jsp?WCAID=<%=ID%>"><center><button class="btn btn-dark" ><i class="fas fa-user-graduate">Grup</i></button></center></a> </th>
                                                <th><a href="agregarStaff.jsp?WCAID=<%=ID%>"><center><button class="btn btn-dark" ><i class="fas fa-user-graduate">Staff</i></button></center></a> </th>
                                            </tr>
                                        </tbody>
                            <%
                                    }
